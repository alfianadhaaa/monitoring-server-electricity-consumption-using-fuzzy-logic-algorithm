            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4" style="height: 400px;">
                        ...
                        <div class="card-body">
                            <img src="<?= base_url(); ?>img/offline.png" alt="Gambar Offline" class="img-fluid mx-auto d-block" style="max-width: 300px;">
                            <h4 class="mt-3 text-center">Check Ip Address Device</h4>
                        </div>
                    </div>
                </div>
